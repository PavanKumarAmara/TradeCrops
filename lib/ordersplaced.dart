...
class OrdersPlacedScreen extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _OrdersPlacedScreenState();
      ...
      body: SingleChildScrollView(
        ...
        child: Align(
          ...
          child:Column(
            ...
            children: [
              Text("ORDERS PLACED", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 32, color: Color(0xFF79651F)),),
              SizedBox(height: 32,),
              Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text("  Order Placed  ", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold),)
                  ),
                  Padding(
                    padding: EdgeInsets.all(10),
